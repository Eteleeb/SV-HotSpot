...
sub identify_peaks
{
   ...
   system ("detect-peaks.r $sv_type $chrom $peakPick_win $peakPick_minsd $pct_samples_t $output_dir $merge_pct_samples $stop_merge_num_peaks $genes_of_int $chromsize_file");
